...
export const mockTraces: Trace[] = [
  //trace 1, 200 OK
  {
    ...
    steps: [
      ...
      },
      {
        ...
        direction: "downstream",
        event: "success",
        timestampStart: new Date(now - 59993).toISOString(),
        durationMs: 0.1,
        logs: ["Session restored from store."]
      },
      {
        middleware: "Routing",
        direction: "downstream",
      ...
      },
      {
        ...
        direction: "downstream",
        event: "success",
        timestampStart: new Date(now - 59988).toISOString(),
        durationMs: 0.1
      },
      {
        ...
        direction: "downstream",
        event: "success",
        timestampStart: new Date(now - 59987).toISOString(),
        durationMs: 0.5,
      ...
      },
      {
        ...
        direction: "downstream",
        event: "success",
        timestampStart: new Date(now - 59983).toISOString(),
        durationMs: 35.0,
      ...
      },
      {
        ...
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59939).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Routing",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59938).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Session",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59937).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "CORS",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59936).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Security",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59935).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "HSTS",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59934).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "HTTPS",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59933).toISOString(),
        durationMs: 0.1,
        logs: ["Forward protocol is https.", "Bypassing redirect."]
      },
      {
        ...
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59932).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Request Limits",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59931).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Exception",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 59930).toISOString(),
        durationMs: 0.1
      }
    ]
  },

  //trace 2, 400 Bad Request
  {
    id: "1002",
    userId: "1",
  ...
  //trace 3, 401 Unauthorized
  {
    ...
    steps: [
      ...
      },
      {
        ...
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29981).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Session",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29980).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "CORS",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29979).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Security",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29978).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "HSTS",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29977).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "HTTPS",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29976).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Connection",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29975).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Request Limits",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29974).toISOString(),
        durationMs: 0.1
      },
      {
        middleware: "Exception",
        direction: "upstream",
        event: "success",
        timestampStart: new Date(now - 29973).toISOString(),
        durationMs: 0.1
      }
    ]
  },
  ...
  //trace 5, 500 Internal Server Error, within termination middleware
  {
    id: "1005",
    userId: "1",
    timestampStart: new Date(now - 60000).toISOString(),
    ...
    steps: [
      ...
      },
      {
        ...
        timestampStart: new Date(now - 59992).toISOString(),
        durationMs: 1.2,
        logs: ["Matched route: GetUserOrders"]
      },
      {
        middleware: "CSRF",
        direction: "downstream",
